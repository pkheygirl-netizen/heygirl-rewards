...
export function renderLandingPage(data: CustomerResponse) {
  ...
  div.id = "hg-landing";
  div.innerHTML =
`<div class="s" style="padding-top:0;border-bottom:none!important"><div style="background:linear-gradient(135deg,${P},#c2185b);color:#fff;border-radius:14px;padding:26px 14px;text-align:center"><h1 style="font-size:21px;font-weight:900;margin-bottom:5px">HeyGirl Rewards ✨</h1><p style="font-size:13px;opacity:.9;margin-bottom:3px">Earn points. Unlock perks. Shop smarter.</p><small style="opacity:.6">Join 10,000+ members</small><div style="display:flex;gap:6px;justify-content:center;flex-wrap:wrap;margin-top:12px">${heroBtns}</div></div></div>
...
<div class="s"><div style="background:linear-gradient(135deg,#fdf0f8,#f7e8f2);border-radius:12px;padding:18px;text-align:center"><b>Refer Friends, Earn More</b><p style="font-size:13px;color:#555;margin:5px 0 9px">Earn 6,000 pts per friend who shops. They get free shipping on first order.</p>${refCta}</div></div>
